...
int display_objects_helper(window_t *win, monster_stats_t *monster, int check, int change)
{
...
void display_obejct_draw_rect(fbutton_t *button, window_t *win, player_stats_t *player, monster_stats_t *monster)
{
...
int display_objects_result(fbutton_t *button, window_t *win, player_stats_t *player, monster_stats_t *monster)
{
    static int change = 0;
    static int check = 0;
